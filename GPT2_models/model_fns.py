...
from GPT2_models.optimizers import create_train_op
from GPT2_models.metric_fns import *

def gpt2_model(features, labels, mode, params):
    from GPT2_models.models.gpt2 import gpt2
    ...
    if mode == tf.estimator.ModeKeys.PREDICT:
        from GPT2_models.models.gpt2 import sample
